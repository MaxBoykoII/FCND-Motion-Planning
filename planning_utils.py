...
def valid_actions(grid, current_node):
    ...
    if not Action.NORTH in valid_actions or not Action.WEST in valid_actions:
        valid_actions.remove(Action.NORTH_WEST)
    if not Action.NORTH in valid_actions or not Action.EAST in valid_actions:
        valid_actions.remove(Action.NORTH_EAST)
    if not Action.SOUTH in valid_actions or not Action.WEST in valid_actions:
        valid_actions.remove(Action.SOUTH_WEST)
    if not Action.SOUTH in valid_actions or not Action.EAST in valid_actions:
